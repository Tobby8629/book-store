...
# 📖<a name="about-project">BOOK_STORE</a>


***Book store is a project built majorly with react with feature to add books and remove books***


## 🛠 Built With <a name="built-with">VSCode</a>

### <a name="tech-stack">REACT, Javascript, CSS</a>
...
gh repo clone https://github.com/Tobby8629/book-store.git
...
- [ ] **[section to show category of books]()**
...
Feel free to check the [issues page](https://github.com/Chaseknis/book-store/issues).
